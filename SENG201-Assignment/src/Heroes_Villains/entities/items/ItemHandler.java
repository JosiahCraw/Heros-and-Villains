...
public class ItemHandler {
    ...
    public ItemHandler(Game game, Citys citys, Player player) {
        ...
        basicPotion = new HealingItem(0, "Basic Potion", Assets.basicPotion, game, citys, 25);
        advancedPotion = new HealingItem(1, "Advanced Potion", Assets.advancedPotion, game, citys, 50);
        masterPotion = new HealingItem(2, "Master Potion", Assets.masterPotion, game, citys, 75);
